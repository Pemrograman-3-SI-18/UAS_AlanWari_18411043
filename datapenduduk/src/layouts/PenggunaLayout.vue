            ...
            <div class="row no-wrap q-pa-lg">
              <div class="column">
                ...
                <div class="items-center">
                  <div class="text-bold items-center">2</div>
                  <div>PENGGUNA</div>
                </div>
              </div>
        ...
        <q-list>
          ...
          <q-item class="justify-center text-center q-mb-md q-pt-md">
            <div>
              ...
              <div class="text-weight-bold">2</div>
              <div>PENGGUNA</div>
            </div>
          </q-item>
          <q-item-label
          ...
          <q-item clickable active-class="active" exact v-ripple to="/pengguna">
...
export default {
  ...
  data () {
    return {
      left: false, dataUser: this.$q.localStorage.getItem('datauser')
    }
  },
  methods: {
    keluar () {
